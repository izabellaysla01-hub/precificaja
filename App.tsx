...
export default function App() {
  ...
  const enviarZap = (p: any) => {
    ...
    const msg = `*ORÇAMENTO - PrecificaJá*%0A---%0A*Cliente:* ${cli?.nome || 'Cliente'}%0A*Produto:* ${p.nomeProd}%0A*Qtd:* ${p.qtdPed || 1} un%0A*Prazo:* ${dataP}%0A*VALOR TOTAL:* R$ ${p.preco}%0A---%0AObrigado!`;
